...
int64_t getTimeStampMs() { return dolphindb::Util::getEpochTime(); }
...
TEST_F(DolphinDBTest, testSymbolBase) {
  ...
  conn.run("undef(all)");
  conn.run(
      "t=table(symbol(string(1..2000000)) as sym,symbol(string(1..2000000)) as sym1,symbol(string(1..2000000)) as "
      "sym2,symbol(string(1..2000000)) as sym3,symbol(string(1..2000000)) as sym4,symbol(string(1..2000000)) as "
      "sym5,symbol(string(1..2000000)) as sym6,symbol(string(1..2000000)) as sym7,symbol(string(1..2000000)) as "
      "sym8,symbol(string(1..2000000)) as sym9)");
  startTime = getTimeStampMs();
  conn.run("t");
  time = getTimeStampMs() - startTime;
  ...
  conn.run("undef(all)");
  conn.run(
      "t=table(symbol(take(string(0..20000),2000000)) as sym,symbol(take(string(20000..40000),2000000)) as "
      "sym1,symbol(take(string(40000..60000),2000000)) as sym2,symbol(take(string(60000..80000),2000000)) as "
      "sym3,symbol(take(string(80000..100000),2000000)) as sym4,symbol(take(string(100000..120000),2000000)) as "
      "sym5,symbol(take(string(120000..140000),2000000)) as sym6,symbol(take(string(140000..160000),2000000)) as "
      "sym7,symbol(take(string(160000..180000),2000000)) as sym8,symbol(take(string(180000..200000),2000000)) as "
      "sym9)");
  startTime = getTimeStampMs();
  conn.run("t");
  time = getTimeStampMs() - startTime;
...
TEST_F(DolphinDBTest, testSymbolSmall) {
  ...
  conn.run(
      "t=table(symbol(string(1..200)) as sym,symbol(string(1..200)) as sym1,symbol(string(1..200)) as "
      "sym2,symbol(string(1..200)) as sym3,symbol(string(1..200)) as sym4,symbol(string(1..200)) as "
      "sym5,symbol(string(1..200)) as sym6,symbol(string(1..200)) as sym7,symbol(string(1..200)) as "
      "sym8,symbol(string(1..200)) as sym9)");
  startTime = getTimeStampMs();
  conn.run("t");
  time = getTimeStampMs() - startTime;
  std::cout << "table with same symbol vectors:" << time << "ms" << std::endl;
  ...
  conn.run(
      "t=table(symbol(take(string(0..20000),200)) as sym,symbol(take(string(20000..40000),200)) as "
      "sym1,symbol(take(string(40000..60000),200)) as sym2,symbol(take(string(60000..80000),200)) as "
      "sym3,symbol(take(string(80000..100000),200)) as sym4,symbol(take(string(100000..120000),200)) as "
      "sym5,symbol(take(string(120000..140000),200)) as sym6,symbol(take(string(140000..160000),200)) as "
      "sym7,symbol(take(string(160000..180000),200)) as sym8,symbol(take(string(180000..200000),200)) as sym9)");
  startTime = getTimeStampMs();
  conn.run("t");
  time = getTimeStampMs() - startTime;
  std::cout << "table with diff symbol vectors:" << time << "ms" << std::endl;
...
TEST_F(DolphinDBTest, testSymbolNull) {
  ...
  conn.run(
      "t=table(take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as "
      "sym1,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym2,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as "
      "sym3,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym4,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as "
      "sym5,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym6,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as "
      "sym7,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym8,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym9)");
  startTime = getTimeStampMs();
  conn.run("t");
  time = getTimeStampMs() - startTime;
  std::cout << "table with same symbol vectors:" << time << "ms" << std::endl;
  ...
  conn.run(
      "t=table(take(symbol(`cdwy`fty``56e`f652dfyfv),2000000) as sym,take(symbol(`cy`f8ty``56e`f65dfyfv),2000000) as "
      "sym1,take(symbol(`c2587y`fty``56e`f65dfyfv),2000000) as sym2,take(symbol(`cy````f65dfy4fv),2000000) as "
      "sym3,take(symbol(`cy```56e`f65dfgyfv),2000000) as sym4,take(symbol(`cy`fty``56e`12547),2000000) as "
      "sym5,take(symbol(`cy`fty``e`f65d728fyfv),2000000) as sym6,take(symbol(`cy`fty``56e`),2000000) as "
      "sym7,take(symbol(`cy`fty``56e`111),2000000) as sym8,take(symbol(`c412y`ft575y```f65dfyfv),2000000) as sym9)");
  startTime = getTimeStampMs();
  conn.run("t");
  time = getTimeStampMs() - startTime;
  std::cout << "table with diff symbol vectors:" << time << "ms" << std::endl;
...
TEST_F(DolphinDBTest, testTable) {
  ...
  script += "n=20000\n";
  script +=
      "syms=`IBM`C`MS`MSFT`JPM`ORCL`BIDU`SOHU`GE`EBAY`GOOG`FORD`GS`PEP`USO`GLD`GDX`EEM`FXI`SLV`SINA`BAC`AAPL`PALL`YHOO`"
      "KOH`TSLA`CS`CISO`SUN\n";
  script +=
      "mytrades=table(09:30:00+rand(18000,n) as timestamp,rand(syms,n) as sym, 10*(1+rand(100,n)) as "
      "qty,5.0+rand(100.0,n) as price, 1..n as number,rand(syms,n) as sym_2);\n";
...
TEST_F(DolphinDBTest, testStringVectorHash) {
  std::vector<std::string> testValues{
      "9223372036854775807", "helloworldabcdefghijklmnopqrstuvwxyz", "智臾科技a", "hello,智臾科技a", "123abc您好！a", ""};
  int buckets[5] = {13, 43, 71, 97, 4097};
  int expected[5][6] = {
      {8, 1, 9, 3, 3, 0}, {37, 20, 25, 25, 27, 0}, {31, 0, 65, 54, 15, 0}, {24, 89, 46, 52, 79, 0}, {739, 3737, 2208, 1485, 376, 0}};
  int hv[6] = {0};
...
TEST_F(DolphinDBTest, testUUIDvectorHash) {
  std::string script;
  script =
      "a=rand(uuid(),6);table(a as k,hashBucket(a,13) as v1,hashBucket(a,43) as v2,hashBucket(a,71) as "
      "v3,hashBucket(a,97) as v4,hashBucket(a,4097) as v5)";
  ...
  for(int i = 0; i < t->size(); i++) v->append(dolphindb::Util::parseConstant(dolphindb::DT_UUID, t->getColumn(0)->getString(i)));
  for(unsigned int j = 0; j < 5; j++) {
    v->getHash(0, 6, buckets[j], hv);
    for(unsigned int k = 0; k < t->size(); k++) {
      ASSERT_EQ(hv[k], expected[j][k]);
...
TEST_F(DolphinDBTest, testIpAddrvectorHash) {
  std::string script;
  script =
      "a=rand(ipaddr(),6);table(a as k,hashBucket(a,13) as v1,hashBucket(a,43) as v2,hashBucket(a,71) as "
      "v3,hashBucket(a,97) as v4,hashBucket(a,4097) as v5)";
  dolphindb::TableSP t = conn.run(script);
  ...
  for(int i = 0; i < t->size(); i++) v->append(dolphindb::Util::parseConstant(dolphindb::DT_IP, t->getColumn(0)->getString(i)));
  for(unsigned int j = 0; j < 5; j++) {
    v->getHash(0, 6, buckets[j], hv);
    for(unsigned int k = 0; k < t->size(); k++) {
      ASSERT_EQ(hv[k], expected[j][k]);
...
TEST_F(DolphinDBTest, testInt128vectorHash) {
  std::string script;
  script =
      "a=rand(int128(),6);table(a as k,hashBucket(a,13) as v1,hashBucket(a,43) as v2,hashBucket(a,71) as "
      "v3,hashBucket(a,97) as v4,hashBucket(a,4097) as v5)";
  dolphindb::TableSP t = conn.run(script);
  ...
  for(int i = 0; i < t->size(); i++) v->append(dolphindb::Util::parseConstant(dolphindb::DT_INT128, t->getColumn(0)->getString(i)));
  for(unsigned int j = 0; j < 5; j++) {
    v->getHash(0, 6, buckets[j], hv);
    for(unsigned int k = 0; k < t->size(); k++) {
      ASSERT_EQ(hv[k], expected[j][k]);
...
TEST_F(DolphinDBTest, test_symbol_optimization) {
  ...
  std::vector<dolphindb::DATA_TYPE> colTypes = {dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL,
                                                dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL,
                                                dolphindb::DT_SYMBOL, dolphindb::DT_SYMBOL};
  ...
  for(int i = 0; i < colNum; i++) columnVecs.emplace_back(t11->getColumn(i));
  ...
  script1 += "n=2000000;";
  script1 +=
      "tmp=table(take(symbol(\"A\"+string(0..999)), n) as col1, take(symbol(\"B\"+string(0..999)), n) as col2,\
