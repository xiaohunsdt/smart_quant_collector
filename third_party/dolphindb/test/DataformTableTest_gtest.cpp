...
TEST_F(DataformTableTest, testStringTable) {
  ...
  std::string judgestr =
      "res1=(a==tab1);res2=(a==tab2);res3=(a==tab3);\n\
                    res1.append!(res2)\n\
                    res1.append!(res3)\n\
                    res1";
  ...
  ASSERT_EQ(tab1->get(0)->get(dolphindb::Util::createString("string"))->getString(),
            dict1->get(dolphindb::Util::createString("string"))->getString());
...
TEST_F(DataformTableTest, testCharNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_CHAR),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_CHAR)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testIntNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_INT),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_INT)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testLongNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_LONG),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_LONG)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testShortNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_SHORT),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_SHORT)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testFloatNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_FLOAT),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_FLOAT)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDoubleNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DOUBLE),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DOUBLE)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDatehourNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DATEHOUR),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DATEHOUR)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDateNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DATE),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DATE)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testMinuteNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_MINUTE),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_MINUTE)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDatetimeNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DATETIME),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DATETIME)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testTimestampNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_TIMESTAMP),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_TIMESTAMP)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testNanotimeNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_NANOTIME),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_NANOTIME)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testNanotimestampNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_NANOTIMESTAMP),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_NANOTIMESTAMP)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testMonthNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_MONTH),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_MONTH)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testTimeNullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_TIME),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_TIME)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDecimal32NullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DECIMAL32, scale1),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DECIMAL32, scale2)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDecimal64NullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DECIMAL64, scale1),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DECIMAL64, scale2)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
TEST_F(DataformTableTest, testDecimal128NullTable) {
  ...
  std::vector<dolphindb::ConstantSP> cols = {dolphindb::Util::createNullConstant(dolphindb::DT_DECIMAL128, scale1),
                                             dolphindb::Util::createNullConstant(dolphindb::DT_DECIMAL128, scale2)};
  dolphindb::TableSP tab3 = dolphindb::Util::createTable(colNames, cols);
...
dolphindb::TableSP createDemoTable() {
  ...
  std::vector<dolphindb::VectorSP> columnVecs;
  columnVecs.reserve(colNum);
  for(int i = 0; i < colNum; i++) columnVecs.emplace_back(table->getColumn(i));
...
TEST_F(DataformTableTest, testDFSTable) {
  ...
  conn.run(script);
  for(int i = 0; i < 3; i++) ASSERT_TRUE(conn.run("each(eqObj, res.values(), mt.values());")->get(i)->getBool());
}
...
TEST_F(DataformTableTest, testinMemoryTableMoreThan65535) {
  ...
  for(int i = 0; i < colNum; i++) ASSERT_EQ(tab1->getColumn(i)->getType(), res_tab->getColumn(i)->getType());
}
...
TEST_F(DataformTableTest, test_BlockReader_getInmemoryTable) {
  ...
  script.append(
      "syms= "
      "`IBM`C`MS`MSFT`JPM`ORCL`BIDU`SOHU`GE`EBAY`GOOG`FORD`GS`PEP`USO`GLD`GDX`EEM`FXI`SLV`SINA`BAC`AAPL`PALL`YHOO`KOH`"
      "TSLA`CS`CISO`SUN\n");
  script.append(
      "mytrades=table(09:30:00+rand(18000, n) as timestamp, rand(syms, n) as sym, 10*(1+rand(100, n)) as qty, "
      "5.0+rand(100.0, n) as price); \n");
  conn.run(script);
...
static void Block_Table() {
  ...
  script += "rows=12453;";
  script +=
      "testblock=table(take(1,rows) as id,take(`A,rows) as symbol,take(2020.08.01..2020.10.01,rows) as date, "
      "rand(50,rows) as size,rand(50.5,rows) as price);";
  DataformTableTest::conn.run(script);
...
TEST_F(DataformTableTest, testinMemoryTableMoreThan1048576withAlldataTypes) {
  ...
  {  // test class dolphindb::ResultSet(dolphindb::TableSP)
    ...
    while(resultSet.isAfterLast() == false) {
      ...
      int colIndex = 0;
      if(resultSet.isFirst()) std::cout << "resultset assert begins" << std::endl;

      for(auto i = 0; i < colNum; i++) {
        resultSet.getBinary(i);
        // ASSERT_EQ(*resultSet.getBinary(i), *(res_tab->getColumn(i)->get(rowIndex)->getBinary())); //
        // https://dolphindb1.atlassian.net/browse/AC-408
        if(i == 25)
          ASSERT_EQ(resultSet.getDataType(i), dolphindb::DT_SYMBOL);
        else
          ASSERT_EQ(resultSet.getDataType(i), res_tab->getColumnType(i));
      }
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createChar(resultSet.getChar(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createBool(resultSet.getBool(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createShort(resultSet.getShort(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createInt(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createLong(resultSet.getLong(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createDate(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createMonth(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createTime(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createMinute(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createDateTime(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createSecond(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createTimestamp(resultSet.getLong(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createNanoTime(resultSet.getLong(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createNanoTimestamp(resultSet.getLong(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createFloat(resultSet.getFloat(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createDouble(resultSet.getDouble(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createString(resultSet.getString(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ...
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createDateHour(resultSet.getInt(colIndex++)))->getString(),
                res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(resultSet.getObject(colIndex++)->getString(), res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(resultSet.getObject(colIndex++)->getString(), res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(resultSet.getObject(colIndex++)->getString(), res_tab->getColumn(colIndex)->get(rowIndex)->getString());
      ...
      if(resultSet.isLast()) std::cout << "resultset assert finished" << std::endl;
      resultSet.next();
    }
    resultSet.last();
    resultSet.next();
...
TEST_F(DataformTableTest, testTablewithArrayVector) {
  ...
  conn.run(
      ...
      "table1=table(cchar,cbool,cshort,cint,clong,cdate,cmonth,ctime,cminute,cdatetime,csecond,ctimestamp,cnanotime,"
      "cnanotimestamp,cdatehour,cfloat,cdouble,cuuid,cipaddr,cint128,cdecimal32,cdecimal64,cdecimal128);"
      "for (i in 1:" +
      std::to_string(rowNum - 1) +
      "){"
      "    tableInsert(table1, "
      "cchar,cbool,cshort,cint,clong,cdate,cmonth,ctime,cminute,cdatetime,csecond,ctimestamp,cnanotime,cnanotimestamp,"
      "cdatehour,cfloat,cdouble,cuuid,cipaddr,cint128,cdecimal32,cdecimal64,cdecimal128)}"
      "tableInsert(table1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,"
...
TEST_F(DataformTableTest, test_MvccTableMoreThan1048576_withAlldataTypes) {
  ...
  conn.upload("tab1", {tab1});
  dolphindb::TableSP mvcc_tab2 = conn.run(
      "colNames = schema(tab1).colDefs[`name];colTypes = schema(tab1).colDefs[`TypeInt];tab2 = mvccTable(1:0, "
      "colNames,colTypes).append!(tab1);tab2");
  ...
  {  // test class dolphindb::ResultSet(dolphindb::TableSP)
    ...
    while(resultSet.isAfterLast() == false) {
      ...
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createChar(resultSet.getChar(colIndex++)))->getString(),
                mvcc_tab2->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createBool(resultSet.getBool(colIndex++)))->getString(),
                mvcc_tab2->getColumn(colIndex)->get(rowIndex)->getString());
      ASSERT_EQ(((dolphindb::ConstantSP)dolphindb::Util::createShort(resultSet.getShort(colIndex++)))->getString(),
                mvcc_tab2->getColumn(colIndex)->get(rowIndex)->getString());
