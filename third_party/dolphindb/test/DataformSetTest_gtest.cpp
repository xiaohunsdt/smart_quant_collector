...
TEST_F(DataformSetTest, testCharSet) {
  ...
  for(auto i = 0; i < 200; i++) v2->append(dolphindb::Util::createChar(i));
  std::cout << v2->getString() << std::endl;
}
...
TEST_F(DataformSetTest, testCharSetEqual128) {
  ...
  for(int i = 0; i < 128; i++) v1->append(dolphindb::Util::createChar(i));
...
TEST_F(DataformSetTest, testShortSetEqual256) {
  ...
  for(int i = 0; i < 256; i++) v1->append(dolphindb::Util::createShort(i));
...
TEST_F(DataformSetTest, testIntSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createInt(i));
...
TEST_F(DataformSetTest, testLongSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createLong(i));
...
TEST_F(DataformSetTest, testDateSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createDate(i));
...
TEST_F(DataformSetTest, testMonthSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createMonth(i));
...
TEST_F(DataformSetTest, testTimeSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createTime(i));
...
TEST_F(DataformSetTest, testMinuteSetEqual1440) {
  ...
  for(int i = 0; i < 1440; i++) v1->append(dolphindb::Util::createMinute(i));
...
TEST_F(DataformSetTest, testSecondSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createSecond(i));
...
TEST_F(DataformSetTest, testDatetimeSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createDateTime(i));
...
TEST_F(DataformSetTest, testTimestampSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createTimestamp(i));
...
TEST_F(DataformSetTest, testNanotimeSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createNanoTime(i));
...
TEST_F(DataformSetTest, testNanotimestampSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createNanoTimestamp(i));
...
TEST_F(DataformSetTest, testFloatSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createFloat(i));
...
TEST_F(DataformSetTest, testDoubleSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createDouble(i));
...
TEST_F(DataformSetTest, testStringSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createString(std::to_string(i)));
...
TEST_F(DataformSetTest, testDatehourSetMoreThan65535) {
  ...
  for(int i = 0; i < 70000; i++) v1->append(dolphindb::Util::createDateHour(i));
...
TEST_F(DataformSetTest, testIntSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createInt(i));
...
TEST_F(DataformSetTest, testLongSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createLong(i));
...
TEST_F(DataformSetTest, testDateSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createDate(i));
...
TEST_F(DataformSetTest, testMonthSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createMonth(i));
...
TEST_F(DataformSetTest, testTimeSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createTime(i));
...
TEST_F(DataformSetTest, testSecondSetEqual86400) {
  ...
  for(int i = 0; i < 86400; i++) v1->append(dolphindb::Util::createSecond(i));
...
TEST_F(DataformSetTest, testDatetimeSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createDateTime(i));
...
TEST_F(DataformSetTest, testTimestampSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createTimestamp(i));
...
TEST_F(DataformSetTest, testNanotimeSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createNanoTime(i));
...
TEST_F(DataformSetTest, testNanotimestampSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createNanoTimestamp(i));
...
TEST_F(DataformSetTest, testFloatSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createFloat(i));
...
TEST_F(DataformSetTest, testDoubleSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createDouble(i));
...
TEST_F(DataformSetTest, testStringSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createString(std::to_string(i)));
...
TEST_F(DataformSetTest, testDatehourSetMoreThan1048576) {
  ...
  for(int i = 0; i < 1100000; i++) v1->append(dolphindb::Util::createDateHour(i));
