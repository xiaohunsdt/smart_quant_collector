...
TEST_F(SysIOTest, test_Socket_No_Parameter) {
  ...
  ASSERT_EQ(s1.read(val, 6, actualLength),
            dolphindb::NODATA);  // when send tcp-data to connected socket(host:port), it can read datas;
...
INSTANTIATE_TEST_SUITE_P(test_DataStream_scalar_Temporal_Null, SysIOTest_Parameterized,
                         testing::Values(dolphindb::DT_DATE, dolphindb::DT_MONTH, dolphindb::DT_TIME, dolphindb::DT_MINUTE, dolphindb::DT_SECOND,
                                         dolphindb::DT_DATETIME, dolphindb::DT_TIMESTAMP, dolphindb::DT_NANOTIME, dolphindb::DT_NANOTIMESTAMP,
...
INSTANTIATE_TEST_SUITE_P(test_DataStream_scalar_Integral_Null, SysIOTest_Parameterized,
                         testing::Values(dolphindb::DT_UUID, dolphindb::DT_IP, dolphindb::DT_INT128));
...
INSTANTIATE_TEST_SUITE_P(test_DataStream_vector_Null, SysIOTest_Parameterized,
                         testing::Values(dolphindb::DT_BOOL, dolphindb::DT_CHAR, dolphindb::DT_SHORT, dolphindb::DT_INT, dolphindb::DT_LONG,
                                         dolphindb::DT_DATE, dolphindb::DT_MONTH, dolphindb::DT_TIME, dolphindb::DT_MINUTE, dolphindb::DT_SECOND,
                                         dolphindb::DT_DATETIME, dolphindb::DT_TIMESTAMP, dolphindb::DT_NANOTIME, dolphindb::DT_NANOTIMESTAMP,
                                         dolphindb::DT_FLOAT, dolphindb::DT_DOUBLE, dolphindb::DT_SYMBOL, dolphindb::DT_STRING, dolphindb::DT_UUID,
                                         dolphindb::DT_DATEHOUR, dolphindb::DT_IP, dolphindb::DT_INT128, dolphindb::DT_BLOB, dolphindb::DT_DECIMAL32,
...
INSTANTIATE_TEST_SUITE_P(test_DataStream_table_Null, SysIOTest_Parameterized,
                         testing::Values(dolphindb::DT_BOOL, dolphindb::DT_CHAR, dolphindb::DT_SHORT, dolphindb::DT_INT, dolphindb::DT_LONG,
                                         dolphindb::DT_DATE, dolphindb::DT_MONTH, dolphindb::DT_TIME, dolphindb::DT_MINUTE, dolphindb::DT_SECOND,
                                         dolphindb::DT_DATETIME, dolphindb::DT_TIMESTAMP, dolphindb::DT_NANOTIME, dolphindb::DT_NANOTIMESTAMP,
                                         dolphindb::DT_FLOAT, dolphindb::DT_DOUBLE, dolphindb::DT_SYMBOL, dolphindb::DT_STRING, dolphindb::DT_UUID,
