...
class StreamingIPCinMemoryTableTest : public testing::Test {
 ...
 protected:
  ...
  virtual void SetUp() {
    ...
    conn.run("try{dropIPCInMemoryTable(`" + case_ +
             ");}catch(ex){};\
                share streamTable(10000:0,`timestamp`temperature`currenttime, [TIMESTAMP,DOUBLE,NANOTIMESTAMP]) as " +
             case_ +
             ";\n\
                shm_test=createIPCInMemoryTable(1000000, \"" +
             case_ +
             "\", `timestamp`temperature`currenttime, [TIMESTAMP, DOUBLE, NANOTIMESTAMP]);\n\
                def shm_append(msg){loadIPCInMemoryTable(`" +
             case_ +
             ").append!(msg)};\
                topic2 = subscribeTable(tableName=\"" +
             case_ + "\", actionName=\"act3\", offset=0, handler=shm_append, msgAsTable=true);");
  }
...
int insertTask(int insertNum, int sleepMS) {
  std::string case_ = getCaseNameHash();
  StreamingIPCinMemoryTableTest::conn.run("n=" + std::to_string(insertNum) + ";tableInsert(" + case_ +
                                          ",rand(1..100,n),norm(2,0.4,n),take(now(true),n));sleep(" + std::to_string(sleepMS) + ")");
...
void print(dolphindb::TableSP table) {
  std::string case_ = getCaseNameHash();
  dolphindb::ConstantSP time_spend =
      StreamingIPCinMemoryTableTest::conn.run("cur_tm=now(true);insert_total_time = exec max(currenttime) from loadIPCInMemoryTable(`" + case_ +
                                              ");\n\
                                    tm_spend=cur_tm-insert_total_time;\n\
                                    nanotime(tm_spend)");
  std::cout << "total get rows: " << table->rows() << std::endl << "total time spend: " << time_spend->getString() << std::endl << std::endl;
}
...
TEST_F(StreamingIPCinMemoryTableTest, test_subscribeUnsubscribe_with_gt1048576rows) {
  ...
  std::thread th_new = std::thread([=]() {
    ...
    std::string s = "name=`" + tableName +
                    ...
                    "`marketType`securityCode`origTime`tradingPhaseCode`preClosePrice`openPrice`highPrice`lowPrice`lastPrice`"
                    "closePrice`bidPrice1`bidPrice2`bidPrice3`bidPrice4`bidPrice5`bidPrice6`bidPrice7`bidPrice8`bidPrice9`"
                    "bidPrice10`bidVolume1`bidVolume2`bidVolume3`bidVolume4`bidVolume5`bidVolume6`bidVolume7`bidVolume8`bidVolume9`"
                    "bidVolume10`offerPrice1`offerPrice2`offerPrice3`offerPrice4`offerPrice5`offerPrice6`offerPrice7`offerPrice8`"
                    "offerPrice9`offerPrice10`offerVolume1`offerVolume2`offerVolume3`offerVolume4`offerVolume5`offerVolume6`"
                    "offerVolume7`offerVolume8`offerVolume9`offerVolume10`numTrades`totalVolumeTrade`totalValueTrade`"
                    "totalBidVolume`totalOfferVolume`weightedAvgBidPrice`weightedAvgOfferPrice`ioPV`yieldToMaturity`highLimited`"
                    "lowLimited`priceEarningRatio1`priceEarningRatio2`change1`change2`channelNo`mdStreamID`instrumentStatus`"
                    "preCloseIOPV`altWeightedAvgBidPrice`altWeightedAvgOfferPrice`etfBuyNumber`etfBuyAmount`etfBuyMoney`"
                    "etfSellNumber`etfSellAmount`etfSellMoney`totalWarrantExecVolume`warLowerPrice`warUpperPrice`withdrawBuyNumber`"
                    "withdrawBuyAmount`withdrawBuyMoney`withdrawSellNumber`withdrawSellAmount`withdrawSellMoney`totalBidNumber`"
                    "totalOfferNumber`bidTradeMaxDuration`offerTradeMaxDuration`numBidOrders`bnumOfferOrders`lastTradeTime`"
                    "varietyCategory`receivedTime`dailyIndex,"
                    ...
                    "rand(1 2 3 4, 1), rand(`apl`ffffffffffffffffffffffffffffffffgoog`ms`agggggggggggggma, 1), now(), "
                    "rand(`s1asdgzxcaw`s2gggggggg`s333333333`s4aaaaasdzx,1), "
                    "rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),"
                    "rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),"
                    "rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),"
                    "rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),"
                    "rand(100000, 1),rand(`a1zzzzzzz`a2xxxxxxxx`a3qqqqqqqqqqqqqq`a4ghhhhhhhhhhhhhhhhh, "
                    "1),rand(`b1nnnnnnnnnnnnnnnn`b2bbbbbbbbbbbbbbbb`b3hhhhhhhhhhhhhhhh`b4uuuuuuuuuuuuuuuuuuuuuuuuuuu, 1),"
                    "rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand(1000000l,1),rand("
                    "1000000l,1),rand(1000000l,1),"
                    "rand(100000, 1),rand(100000, 1),rand(100000, 1),rand(100000, 1),rand(10000000l, 1),rand(127c, 1), "
                    "now(true),rand(100000, 1));if(i % 100000 == 0){print(string(i)+' rows inserted finished!');}}";
    conn_interval.run(s);
  ...
  std::vector<std::string> colNames = {"marketType",
                                       "securityCode",
                                       "origTime",
                                       "tradingPhaseCode",
                                       "preClosePrice",
  ...
  std::vector<dolphindb::DATA_TYPE> colTypes = {
      dolphindb::DT_INT,    dolphindb::DT_SYMBOL, dolphindb::DT_TIMESTAMP, dolphindb::DT_STRING, dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      ...
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_INT,
      dolphindb::DT_STRING, dolphindb::DT_STRING, dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_LONG,          dolphindb::DT_LONG,
      dolphindb::DT_LONG,   dolphindb::DT_LONG,   dolphindb::DT_LONG,      dolphindb::DT_LONG,   dolphindb::DT_INT,           dolphindb::DT_INT,
      dolphindb::DT_INT,    dolphindb::DT_INT,    dolphindb::DT_LONG,      dolphindb::DT_CHAR,   dolphindb::DT_NANOTIMESTAMP, dolphindb::DT_INT};
  int rowNum = 0, indexCapacity = 10000;
