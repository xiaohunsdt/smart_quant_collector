...
TEST_F(DataformPairTest, testDecimal32Pair) {
  ...
  v1->set(0, val0);
  v1->set(1, val1);
  std::string script = "a=pair(decimal32(`1.1111111111111111111111111111," + std::to_string(scale) +
                       "),decimal32('-3.1111111111111111111111111111'," + std::to_string(scale) + "));a";
  dolphindb::VectorSP res_v = conn.run(script);
  conn.upload("v1", {v1});
  ASSERT_EQ(conn.run("eqObj(v1,a)")->getBool(), true);
  ASSERT_EQ(v1->getScript(), res_v->getScript());
...
TEST_F(DataformPairTest, testDecimal64Pair) {
  ...
  v1->set(0, val0);
  v1->set(1, val1);
  std::string script = "a=pair(decimal64(`1.1111111111111111111111111111," + std::to_string(scale) +
                       "),decimal64('-3.1111111111111111111111111111'," + std::to_string(scale) + "));a";
  dolphindb::VectorSP res_v = conn.run(script);
  conn.upload("v1", {v1});
...
TEST_F(DataformPairTest, testDecimal128Pair) {
  ...
  v1->set(0, val0);
  v1->set(1, val1);
  std::string script = "a=pair(decimal128(`1.1111111111111111111111111111," + std::to_string(scale) +
                       "),decimal128('-3.1111111111111111111111111111'," + std::to_string(scale) + "));a";
  dolphindb::VectorSP res_v = conn.run(script);
  conn.upload("v1", {v1});
  ASSERT_EQ(conn.run("eqObj(v1,a)")->getBool(), true);
  ASSERT_EQ(v1->getScript(), res_v->getScript());
