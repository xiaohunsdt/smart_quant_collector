...
class DLoggerTest : public testing::Test {
 public:
  // Suite
  static void SetUpTestSuite() { dolphindb::DLogger::SetMinLevel(dolphindb::DLogger::LevelDebug); }
  static void TearDownTestSuite() { dolphindb::DLogger::SetMinLevel(default_level); }
};

TEST_F(DLoggerTest, test_logTextType_with_default_level_debug) {
  std::tuple<const char*,         // 字符串常量
             const void*,         // 指针常量
             ...
             >
      args = std::make_tuple("Hello, DolphinDB!",  // const char*
                             nullptr,              // const void*
