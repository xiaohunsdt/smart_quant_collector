...
class EXPORT_DECL DLogger {
 ...
 private:
  ...
  static bool Write(std::string &text, Level level, int deepth, TA first, TArgs... args) {
    if(deepth == 0) {
      if(FormatFirst(text, level) == false) return false;
    }
    text += " " + Create(first);
  ...
  static std::string Create(const void *value) { return Create((unsigned long long)value); }
  static std::string Create(std::string str) { return str; }
  static std::string Create(int value) { return std::to_string(value); }
  static std::string Create(char value) { return std::string(&value, 1); }
  static std::string Create(unsigned value) { return std::to_string(value); }
  static std::string Create(long value) { return std::to_string(value); }
  static std::string Create(unsigned long value) { return std::to_string(value); }
  static std::string Create(long long value) { return std::to_string(value); }
  static std::string Create(unsigned long long value) { return std::to_string(value); }
  static std::string Create(float value) { return std::to_string(value); }
  static std::string Create(double value) { return std::to_string(value); }
  static std::string Create(long double value) { return std::to_string(value); }
};
