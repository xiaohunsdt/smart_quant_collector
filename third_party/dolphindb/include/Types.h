...
enum DATA_CATEGORY { NOTHING, LOGICAL, INTEGRAL, FLOATING, TEMPORAL, LITERAL, SYSTEM, MIXED, BINARY, COMPLEX, ARRAY, DENARY, MAX_CATEGORY };
...
enum PARTITION_TYPE { SEQ, VALUE, RANGE, LIST, HIER, HASH, MAX_PARTITION_TYPE };
