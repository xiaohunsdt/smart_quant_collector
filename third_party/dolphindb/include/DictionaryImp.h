...
class IntAnyDictionary : public AbstractDictionary {
 public:
  ...
  explicit IntAnyDictionary(const std::unordered_map<int, ConstantSP>& dict, DATA_TYPE keyType = DT_INT)
...
class FloatAnyDictionary : public AbstractDictionary {
 public:
  ...
  explicit FloatAnyDictionary(const std::unordered_map<float, ConstantSP>& dict, DATA_TYPE keyType = DT_FLOAT)
      : AbstractDictionary(keyType, DT_ANY), dict_(dict) {}
...
class DoubleAnyDictionary : public AbstractDictionary {
 public:
  ...
  explicit DoubleAnyDictionary(const std::unordered_map<double, ConstantSP>& dict, DATA_TYPE keyType = DT_DOUBLE)
      : AbstractDictionary(keyType, DT_ANY), dict_(dict) {}
...
class LongAnyDictionary : public AbstractDictionary {
 public:
  ...
  explicit LongAnyDictionary(const std::unordered_map<long long, ConstantSP>& dict, DATA_TYPE keyType = DT_LONG)
      : AbstractDictionary(keyType, DT_ANY), dict_(dict) {}
...
class Int128AnyDictionary : public AbstractDictionary {
 public:
  ...
  explicit Int128AnyDictionary(const std::unordered_map<Guid, ConstantSP>& dict, DATA_TYPE keyType = DT_INT128)
      : AbstractDictionary(keyType, DT_ANY), dict_(dict) {}
